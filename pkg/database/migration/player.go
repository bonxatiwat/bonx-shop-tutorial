...
func PlayerMigrate(pctx context.Context, cfg *config.Config) {
	...
	log.Println("Migration player completed: ", results)
	...
	log.Println("Migration player_transactions completed: ", results)
